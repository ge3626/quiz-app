...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas_text = self.canvas.create_text(150, 125, width=280, text="Text", fill="black", font=("Arial", 15, "italic"))
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.canvas_text, text=f"You ended the quiz with the score of {self.quiz.score}/10! Congratulations.")
